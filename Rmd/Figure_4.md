...
```
    ...
    ## [1] stringr_1.6.0      dplyr_1.2.0        RColorBrewer_1.1-3 ggplot2_4.0.2     
    ## 
    ## loaded via a namespace (and not attached):
    ##  [1] vctrs_0.7.2       cli_3.6.5         knitr_1.51        rlang_1.1.7      
    ##  [5] xfun_0.57         stringi_1.8.7     otel_0.2.0        generics_0.1.4   
    ...
    ## [21] compiler_4.5.0    pkgconfig_2.0.3   rstudioapi_0.18.0 farver_2.1.2     
    ## [25] digest_0.6.39     R6_2.6.1          tidyselect_1.2.1  pillar_1.11.1    
    ## [29] magrittr_2.0.4    withr_3.0.2       tools_4.5.0       gtable_0.3.6
